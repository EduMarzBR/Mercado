...
#Tamanho da amostra do teste de estacionaridade
tamanho_amostra = [252]
...
def process_pair(x, y, tamanho_amostra):
    acn1 = pd.read_csv(
...
results = Parallel(n_jobs=-1)(
    delayed(process_pair)(x, y,tamanho_amostra) for i, x in enumerate(acoes) for y in acoes[i + 1 :]
)
